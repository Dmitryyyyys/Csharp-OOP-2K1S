...
namespace Laba_12
{
    public class NNDFileManager
    {
        ...
        {
            const string zipName = @"C:\\labs\\ооп\\lab 12\\lab 12\\ConsoleApp1\\NNDInspect\\NNDFiles.zip";
            if (new DirectoryInfo("C:\\labs\\ооп\\lab 12\\lab 12\\ConsoleApp1\\NNDInspect").GetFiles("*.zip").Length == 0)
            {
